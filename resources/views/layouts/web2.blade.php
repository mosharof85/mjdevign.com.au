...
<head>
    ...
    <style>
        ...
        .orderSummary .promo-input:focus{
            background-color: #EAF7FF;
        }

        .orderSummary .promo-input::placeholder{
            color: #00a6ff;
            opacity: .8;
        }
    ...
    <style>
        ...
        .pageTypeCheckbox.table_on-staep_3 input:checked + label:after{
            top: 4px;
        }

        .pageTypeCheckbox.table_on-staep_3{
            padding-top: 0;
            margin-left: auto;
            margin-right: 100px;
        }

        .pageTypeCheckbox label{
        ...
        .border-bottom2{
            border-bottom: 2px solid rgb(107,127,176);
        }
